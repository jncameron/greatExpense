...
export default class IncomeForm extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      incomeType: props.income ? props.income.incomeType : "",
    ...
    return (
      <form className="form" onSubmit={this.onSubmit}>
        ...
        <Dropdown
          ...
          selection
          value={incomeType}
          onChange={this.onIncomeTypeChange}
        />
        <div>
          <button className="huge ui blue button">Save Income</button>
        </div>
      </form>
    );
  }
